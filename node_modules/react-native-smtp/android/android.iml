...
<module external.linked.project.id="android" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.sun.mail:android-mail:1.5.5@jar" level="project" />
    <orderEntry type="library" name="Gradle: com.sun.mail:android-activation:1.5.5@jar" level="project" />
