(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var SpinnerCircular = function (_a) {
        var color = _a.color, enabled = _a.enabled, size = _a.size, speed = _a.speed, still = _a.still, thickness = _a.thickness, style = _a.style, svgProps = __rest(_a, ["color", "enabled", "size", "speed", "still", "thickness", "style"]);
        var strokeWidth = 4 * (thickness / 100);
        var svgStyle = __assign({ color: color, overflow: 'visible', width: normalizeSize(size) }, style);
    ...
    var SpinnerCircularFixed = function (_a) {
        var color = _a.color, enabled = _a.enabled, size = _a.size, speed = _a.speed, still = _a.still, thickness = _a.thickness, style = _a.style, svgProps = __rest(_a, ["color", "enabled", "size", "speed", "still", "thickness", "style"]);
        var strokeWidth = 4 * (thickness / 100);
        var svgStyle = __assign({ color: color, overflow: 'visible', width: normalizeSize(size) }, style);
        var circleStyle = !still
    ...
    var SpinnerCircularSplit = function (_a) {
        var color = _a.color, enabled = _a.enabled, size = _a.size, speed = _a.speed, still = _a.still, thickness = _a.thickness, style = _a.style, svgProps = __rest(_a, ["color", "enabled", "size", "speed", "still", "thickness", "style"]);
        var strokeWidth = 4 * (thickness / 100);
        var svgStyle = __assign({ color: color, overflow: 'visible', width: normalizeSize(size) }, style);
        var circleStyle = !still
    ...
    var SpinnerInfinity = function (_a) {
        var color = _a.color, enabled = _a.enabled, size = _a.size, speed = _a.speed, still = _a.still, thickness = _a.thickness, style = _a.style, svgProps = __rest(_a, ["color", "enabled", "size", "speed", "still", "thickness", "style"]);
        ...
        if (!enabled)
            return null;
        return (React.createElement("svg", __assign({ fill: "none", viewBox: "0 0 131 55" }, svgProps, { style: svgStyle }),
            ...
            React.createElement("use", { stroke: "rgba(0,0,0,0.44)", strokeWidth: strokeWidth, xlinkHref: "#spinners-react-infinity-path" }),
    ...
    var css_248z$6 = "@keyframes spinners-react-round-outlined-outer{35%,65%{r:2px;stroke-width:4}}@keyframes spinners-react-round-outlined-inner{35%,65%{r:2px;stroke-width:4}}";
    styleInject(css_248z$6);

    var SpinnerRoundOutlined = function (_a) {
        var color = _a.color, enabled = _a.enabled, size = _a.size, speed = _a.speed, still = _a.still, thickness = _a.thickness, style = _a.style, svgProps = __rest(_a, ["color", "enabled", "size", "speed", "still", "thickness", "style"]);
        var svgStyle = __assign({ color: color, overflow: 'visible', width: normalizeSize(size) }, style);
        var strokeWidth = 3 * (thickness / 100);
        var animations = [
    ...
    var SpinnerRoundFilled = function (_a) {
        var color = _a.color, enabled = _a.enabled, size = _a.size, speed = _a.speed, still = _a.still, thickness = _a.thickness, style = _a.style, svgProps = __rest(_a, ["color", "enabled", "size", "speed", "still", "thickness", "style"]);
        var svgStyle = __assign({ color: color, overflow: 'visible', width: normalizeSize(size) }, style);
        var animations = [
            { r: 4 },
    ...
    var css_248z$8 = "@keyframes spinners-react-romb{25%{transform:translate(30px,-30px)}50%{transform:translate(60px)}75%{transform:translate(30px,30px)}}";
    ...
    var SpinnerRomb = function (_a) {
        ...
        return (React.createElement("svg", __assign({ fill: "currentColor" }, svgProps, { style: svgStyle, viewBox: "0 0 96 96" }),
            ...
            React.createElement("g", { style: rombStyle }, coords$1.filter(function (c, i) { return i < 5; }).map(function (c) { return (React.createElement("circle", { key: "h-" + c.x + "-" + c.y, cx: c.x, cy: c.y, r: 3.5 * (thickness / 100) })); }))));
    };
