...
var styleInject_es = require('./style-inject.es-53b0d2f9.js');
...
var SpinnerInfinity = function (_a) {
    var color = _a.color, enabled = _a.enabled, size = _a.size, speed = _a.speed, still = _a.still, thickness = _a.thickness, style = _a.style, svgProps = styleInject_es.__rest(_a, ["color", "enabled", "size", "speed", "still", "thickness", "style"]);
    var strokeWidth = 7 * (thickness / 100);
    var svgStyle = styleInject_es.__assign({ color: color, overflow: 'visible', width: styleInject_es.normalizeSize(size) }, style);
    var dashStyle = !still
        ? { animation: "spinners-react-infinity " + 140 / speed + "s linear infinite" }
        : {};
    if (!enabled)
        return null;
    return (React.createElement("svg", styleInject_es.__assign({ fill: "none", viewBox: "0 0 131 55" }, svgProps, { style: svgStyle }),
...
SpinnerInfinity.defaultProps = styleInject_es.defaultProps;
